...
emma = Person("emma", " gogo", "july-17-2743", "1234", False)
...
emma_account = BankAccount(0, emma)


# In[135]:


emma_account.withdraw(100)


# In[131]:


emma_account.get_info()


# In[132]:


bankFile = open(str(emma.person_uuid)+'.txt', 'rb')
bankFile_account = pickle.load(bankFile)
print(bankFile)
bankFile.close()
